...
export function GET_TRAFFIC_TO_PORT(mac, port) {
  return 'sudo iptables -A OUTPUT -m mac --mac-source ${mac} -dport ${port} -j INET_IN';
}


// I want to watch the source IP address for dest traffic to ports
